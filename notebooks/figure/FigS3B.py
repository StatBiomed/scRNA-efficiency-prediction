...
This script will produce the right panel of figure3 in the supplementary. 
This scatter plot shows the correlation of the splicing efficiency estimated by INSPEcT and scVelo. 
"""
...
plt.savefig("/home/lzbhouruiyan/scRNA-kinetics-prediction/figure/supp/S3B.pdf", dpi=300, bbox_inches='tight')
plt.show()
